...
const ComparePassordHash_1 = __importDefault(require("@libs/ComparePassordHash"));
    ...
    static LoginUser(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const match = yield (0, ComparePassordHash_1.default)(pass, user.password);
                if (!match) {
                    return { error: true, message: "Invalid email or password" };
                }
                const { password } = user, rest = __rest(user, ["password"]);
                const token = yield (0, jwt_1.Authenticate)(rest);
