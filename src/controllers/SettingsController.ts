...
export default class SettingsController {
    ...
    static async CheckUserName(req: Request, res: Response): Promise<any> {
        try {
            const checkUsernameAvailability =
                await SettingsService.CheckUserName(
    ...
    static async UpdateWatermarkStatus(
        ...
        try {
            ...
            const updateResult = await SettingsService.UpdateWatermarkStatus(
                enabled,
                req.user as AuthUser,
            );
    ...
    static async GetWatermarkStatus(req: Request, res: Response): Promise<any> {
        try {
            const { enabled } = await SettingsService.GetWatermarkStatus(
                req.user as AuthUser,
            );
