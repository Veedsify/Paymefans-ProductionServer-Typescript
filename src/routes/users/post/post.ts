...
post.get(
  Paths.API.Post.PersonalPrivatePosts,
  Auth,
  PostController.MyPrivatePosts,
);
...
post.get(
  Paths.API.Post.PersonalPrivateMedia,
  Auth,
  PostController.GetPrivateMedia,
);

// Other User Posts
post.get(
  Paths.API.Post.OtherPrivatePosts,
  Auth,
...
post.get(
  Paths.API.Post.OtherPrivateMedia,
  Auth,
...
post.put(
  Paths.API.Post.UpdatePostAudience,
  Auth,
