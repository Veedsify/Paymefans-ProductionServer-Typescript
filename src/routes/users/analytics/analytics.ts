...
analytics.get(
  "/profile-views/:days",
  Auth,
  AnalyticsController.GetProfileViews,
);
analytics.get(
  "/account-growth/:timeRange",
  Auth,
  AnalyticsController.GetAccountGrowth,
);
analytics.get(
  "/engagement/:timeRange",
  Auth,
  AnalyticsController.GetEngagement,
);
analytics.get("/audience", Auth, AnalyticsController.GetAudience);
analytics.get(
  "/recent-posts/:timeRange",
  Auth,
  AnalyticsController.GetRecentPosts,
);
